...
[exercise 1.9](exercises/1.9.md) [exercise 1.10](exercises/1.10.md) [exercise 1.11](exercises/1.11.md) [`process`](GLOSSARY.md#process) [`procedure`](GLOSSARY.md#procedure) [`tail recursion`](GLOSSARY.md#tail-recursion) [`recursive process`](GLOSSARY.md#recursive-process) [`iterative process`](GLOSSARY.md#iterative-process) [`linear recursive process`](GLOSSARY.md#linear-recursive-process) [`linear iterative process`](GLOSSARY.md#linear-iterative-process) [`deferred operations`](GLOSSARY.md#deferred-operations) [`state variables`](GLOSSARY.md#state-variables)
