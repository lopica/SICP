...
Cũng như trước, ta có thể dùng mô hình thay thế để quan sát tiến trình tính `6!`:
...
**đệ quy đuôi**: tail recursion / tail-recursive <br />
_tiến trình đệ quy_: recursive process <br />
_tiến trình lặp_: iterative process <br />
**tiến trình đệ quy tuyến tính**: linear recursive process <br />
**tiến trình lặp tuyến tính**: linear iterative process <br />
**phép toán bị trì hoãn**: deferred operations <br />
**biến trạng thái**: state variables <br />
