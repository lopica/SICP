...
[`combination`](GLOSSARY.md#combination) [`operator`](GLOSSARY.md#operator) [`argument`](GLOSSARY.md#argument) [`operand`](GLOSSARY.md#operand) [`recursive`](GLOSSARY.md#recursive) [`primitive expression`](GLOSSARY.md#primitive-expression) [`name`](GLOSSARY.md#name) [`environment`](GLOSSARY.md#environment) [`symbol`](GLOSSARY.md#symbol) [`global environment`](GLOSSARY.md#global-environment) [`expression`](GLOSSARY.md#expression) [`program`](GLOSSARY.md#program) [`special form`](GLOSSARY.md#special-form)
