...
2. Áp dụng quy trình mà nó chính là giá trị nằm bên trái ngoài cùng (chính là **phép biến đổi**) với **đối số** chính là các giá trị của các biểu thức con khác (các **phần tử**)

_Quy tắc_ này tuy đơn giản nhưng nó thể hiện một số tính chất chung quan trọng của **tiến trình**. Đầu tiên, ta thấy rằng bước 1 thể hiện rằng để hoàn thành việc **thực thi** một **tiến trình** của _biểu thức kết hợp_, chúng ta cần trước tiên **thực thi** các **tiến trình** ở mỗi **phần tử** của _biểu thức kết hợp_. Do đó, _quy tắc_ thực thi là **đệ quy** theo tự nhiên; đó là tất cả, nó bao gồm việc trong từng bước, nó cần **thực thi** _quy tắc_ của nó.
...
_phép biến đổi có sẵn_: built-in operator <br />
**tên**: name <br />
_trường hợp nguồn_: primitive case <br />
**phép tính**: operation <br />
_liên kết_: associate <br />
**môi trường**: evironment <br />
**ký hiệu**: symbol <br />
**môi trường toàn cục**: global environment <br />
**biểu thức**: expression <br />
**chương trình**: program <br />
_trường hợp đặc biệt_: special form <br />
